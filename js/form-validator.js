...
guestsAmountSelect.addEventListener('change', setCapacityValidity);
roomsAmountSelect.addEventListener('change', setCapacityValidity);
submitButton.addEventListener('click', checkValidation);
typeInput.addEventListener('change', setTypeValidity);
checkInInput.addEventListener('change', setCheckInValidity);
checkOutInput.addEventListener('change', setCheckOutValidity);
